...
const NewsLetter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        ...
        <form className='flex item-center justify-bewteen max-w-2xl w-full md:h-14 h-12'>
            <input type="text" className='bg-gray-200 border border-gray-300 rounded-md h-full border-r-0 outline-none w-full rounded-r-none px-3 text-gray-500' placeholder='Enter you email id' required/>
