...
import { assets, blogData, commentsData} from '../assets/assets';
    ...
    <div className='relative'>
      ...
      <NavBar/>
       ...
       <div className='text-center mt-20 text-gray-600'>
        ...
        border-primary/35 bg-primary/5 font-medium text-primary'>Dale Steyn</p>
       </div>
       ...
       <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
            ...
            <div className='flex flex-col gap-4'>
              {comments.map((item, index) =>(
                <div key = {index} className='relative bg-gray-300 border
                border-primary/5 max-w-xl p-4 rounded text-gray-600'>
                  <div className='flex items-center gap-2 mb-2'>
                    <img src={assets.userIcon} alt="" className='w-6'/>
            ...
            <div className='max-w-3xl mx-auto'>
                ...
                gap-4 max-w-lg'>
                   ...
                   p-2 border border-gray-600 bg-gray-300 rounded outline-none'/>

                   <textarea onChange={(e)=> setContent(e.target.value)} value={content} placeholder='Comment' className='w-full p-2 border
                   border-gray-600 bg-gray-300 rounded outline-none h-48' required></textarea>
            ...
            <div className='my-24 max-w-3xl mx-auto'>
                ...
                <div className='flex'>
                  <img src={assets.FacebookIcon} width = {50} alt="" />
                  <img src={assets.InstagramIcon} width = {50} alt="" />
                  <img src={assets.TwitterIcon} width = {50} alt="" />
                </div>
            </div>
       </div>
       <Footer/>
